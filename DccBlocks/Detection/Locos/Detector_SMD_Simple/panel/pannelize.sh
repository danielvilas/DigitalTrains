...
PCB_SRC=../Detector_SMD_Simple.kicad_pcb 
PCB_DST=Detector_SMD_Simple.kicad_pcb 
#PCB_AREA="96 82 132 96"
PANEL_GRID="3 2"

PCB_SVG_SRC=Detector_SMD_Simple.svg
PCB_SVG_DST=Detector_SMD_Simple_panel.svg
