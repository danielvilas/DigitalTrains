...
\input{chapters/00_Intro/introducion}

\chapter{Como Jugamos}
\input{chapters/01_jugar/jugar.tex}

\part{Normativa}
\chapterimage{chapter_head_1.pdf} % Chapter heading image

\chapter{Introducción a las normativas}
\input{chapters/0X_Normativas_01_Intro/introducion.tex}
...
\input{Examples}
\chapter{Base}
\input{chapters/0x_example/chapter}
%----------------------------------------------------------------------------------------
%	BIBLIOGRAPHY
%----------------------------------------------------------------------------------------
